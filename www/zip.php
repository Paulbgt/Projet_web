...
$id = $_GET['download_id'];
		...
		$rep=scandir('event_picture'); //on liste les fichiers et dossiers dans le dossier selectionner
		...
		foreach ($rep as $file) {
		$zip->addfile("$id/{$file}");//on ajoute le nom du fichier que l'on veut avoir en Zip
