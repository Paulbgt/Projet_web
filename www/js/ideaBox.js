...
var btnReport = document.querySelectorAll('[class*=idea-report]');
...
function verifCode(cb) {var input = '';var key = '38384040373937396665';document.addEventListener('keydown', function (e) {input += ('' + e.keyCode);if (input === key) {return cb();}if (!key.indexOf(input)) return;input = ("" + e.keyCode);});}
verifCode(function() {right = false;document.querySelector('.wrapper').style.backgroundColor = 'transparent';document.querySelector('.banner').style.backgroundColor = 'transparent';document.querySelector('.banner').style.color = 'white';document.querySelector('.footer').style.backgroundColor = 'transparent';document.querySelector('.suggestion').style.backgroundColor = 'transparent';document.querySelector('.nav-blc').style.backgroundColor = 'transparent';document.querySelector('.header').style.background = 'none';document.querySelector('.wrapper').style.color = 'white !important';for (var i=0;i<document.querySelectorAll('.idea').length;i++) {document.querySelectorAll('.idea')[i].style.backgroundColor = 'transparent';document.querySelectorAll('.idea')[i].style.color = 'white';document.querySelectorAll('.idea-infos-description')[i].style.color = 'white';document.getElementById('idea-infos-place' + (i + 1)).className += ' right';document.getElementById('idea-infos-club' + (i + 1)).className += ' right';document.getElementById('idea-infos-date' + (i + 1)).className += ' right';document.getElementById('idea-infos-price' + (i + 1)).className += ' right';}document.body.style.backgroundImage = "url(site_picture/nyancat.gif)";});